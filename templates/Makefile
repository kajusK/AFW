...
# Build rules
#######################
all: codecheck $(OPENCM3_LIB_PATH) $(PROJECT).elf size
...
clean:
	@rm -rf $(BUILD_DIR) $(PROJECT).elf $(PROJECT).map
