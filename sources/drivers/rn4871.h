 ...
 * @param uuid      UUID string of the characteristic (no dashes, same size as services UUID - 16 or
 * 128 bit)
 ...
 * @param max_interval_ms   Maximum time interval between successive communications, larger or equal
 * to min interval
 * @param latency           Number of connection events the device is not required to communicate,
 * less than timeout_ms/max_interval_ms - 1
